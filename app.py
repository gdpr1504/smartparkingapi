...
from resources.admin import AdminRegister, AdminLogin, EditAdmindetails, GetDistricts, Getzones, Studentdetails, SetOutpassesleft
...
api.add_resource(Getzones, '/getzones')
